...
I=[0 0 0];
u = P1-P0; % Line segment
w = P0 - V0; % vector from plane to point
D = dot(n,u); % line segment dot normal
N = -dot(n,w); % minus line segment dot vector from plane to point
check=0;

if abs(D) < 10^-9        % The segment is parallel to plane
